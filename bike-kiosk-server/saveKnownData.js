...
const saveKnownData = async (dataForDatabase, singleFaceImages, environmentImage) => {
    ...
    //save into face_detection table
    try {
    ...
    try {
        const res = await axios.post(process.env.ENV_TARGET_PORT + '/receiveKioskKnownFaceImages', { singleFaceImages, setOfImagesName, environmentImage });
    } catch (error) {
